...
import {
  ListedPokemon,
  PreviewPokemon,
} from '@models/listed-pokemon.interface';
...
export class PokemonListComponent implements OnInit {
  private pokemonListSubject = new BehaviorSubject<
    ListedPokemon['species'] | null
  >(null);
  pokemonList$ = this.pokemonListSubject.asObservable();

  private previewPokemonSubject = new BehaviorSubject<PreviewPokemon | null>(
    null
  );
  ...
  listPokemon(props: paginator): void {
    this.pokemonService
      ...
      .pipe(
        ...
        tap((species) => {
          this.pokemonListSubject.next(species as ListedPokemon['species']);
        })
      )
      .subscribe();
  }
